...
class nave:
    ...
    def __init__(self, tela, telaX, telaY, x, y) -> None:
        self.tela = tela
        #telaX representa a largura da tela e telaY a altura
        self.telaX = telaX
        self.telaY = telaY
        #armazena a imagem 
        self.imagem = pygame.image.load("assets/nave1.png")
        #determina o tamnho da imagem
        self.tamanho = self.imagem.get_rect().size
        #velocidade e posiçoes iniciais
        self.velocidade = 6
        self.x = x
        self.y = y
        ...
        self.tiroIMG = pygame.image.load("assets/lazer.png")
        ...
        self.tiroX = 0
        self.tiroY = 0
        #determina se há um tiro na tela
        self.tiro = False

    def atirar(self):
        if self.tiroX < self.telaX:
    ...
    def controle(self):
        ...
        if teclas[pygame.K_DOWN] and self.y < self.telaY - self.tamanho[1]:
            self.y += self.velocidade
        elif teclas[pygame.K_DOWN]:
            self.y = self.telaY - self.tamanho[1]
        ...
        if teclas[pygame.K_RIGHT] and self.x < self.telaX - self.tamanho[0]:
            self.x += self.velocidade
        elif teclas[pygame.K_RIGHT]:
            self.x = self.telaX - self.tamanho[0]
